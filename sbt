...
#----------
#THAO changes made to customise this script:
#line 344: -offline) addSbt "set every skip in update := true" && shift ;; (changed from addSbt "set offline := true" && shift ;;)
#line 130: declare -r default_jvm_opts="-Dfile.encoding=UTF8 -XX:MaxPermSize=512m -Xms3G -Xmx3G -Xss2M $jit_opts $cms_opts"
#----------
...
declare -r default_jvm_opts="-Dfile.encoding=UTF8 -Xms3G -Xmx3G -Xss2M -XX:MaxPermSize=512m $jit_opts $cms_opts"
  ...
  while [[ $# -gt 0 ]]; do
    ...
    -v|-verbose) verbose=true && log_level=Info && shift ;;
     ...
     -debug-inc) addJava "-Dxsbt.inc.debug=true" && shift ;;
       -offline) addSbt "set every skip in update := true" && shift ;;
